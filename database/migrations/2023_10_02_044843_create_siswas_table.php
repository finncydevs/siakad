    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('siswas')) {
            Schema::create('siswas', function (Blueprint $table) {
                $table->id();
                $table->string('peserta_didik_id')->unique()->nullable()->comment('ID dari Dapodik');
                ...
                // Kolom tambahan yang kita diskusikan
                $table->enum('status', ['Aktif', 'Lulus', 'Mutasi', 'Keluar', 'Non-Aktif'])->default('Aktif');
