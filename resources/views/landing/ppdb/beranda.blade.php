                ...
                <div class="lg:flex lg:items-center lg:justify-between">
                    <div class="lg:w-1/2">
                        ...
                        <h1 class="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-6"
                            ...
                            <span class="block">Mencetak Talenta Digital</span>
                            <span class="block text-yellow-300">Siap Kerja dan Berwirausaha.</span>
                        </h1>
                        <p class="text-xl text-white text-opacity-90 mb-10 max-w-lg" data-aos="fade-right"
                            data-aos-delay="200" data-aos-duration="800">
                            SMAKNIS, SMK Pusat Keunggulan dengan 6 Kompetensi Keahlian yang relevan dengan industri 4.0.
                    ...
                    <div class="lg:w-1/2 mt-12 lg:mt-0 flex justify-center" data-aos="zoom-in" data-aos-delay="400"
                        ...
                        <div
                            ...
                            <p class="text-white text-opacity-80 font-semibold mt-4 text-center">Pendidikan Kejuruan
                                Berkualitas</p>
                        </div>
                    </div>
                </div>
        ...
        <section id="program" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 text-center mb-4" data-aos="fade-up"
                    ...
                    Keunggulan SMAKNIS Sebagai SMK Pilihan
                </h2>
                <p class="text-xl text-gray-600 text-center mb-16 max-w-3xl mx-auto" data-aos="fade-up"
                    ...
                    Kami berkomitmen untuk memberikan lulusan yang siap bersaing di pasar kerja global.
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1 border-t-4 border-primary-blue"
                        ...
                        <div
                            class="flex items-center justify-center w-12 h-12 rounded-full bg-primary-blue text-white mb-4">
                            <i data-lucide="zap" class="w-6 h-6"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Kurikulum Industri</h3>
                        <p class="text-gray-600">Mengadopsi kurikulum yang disusun bersama industri, memastikan
                            keterampilan siswa relevan dengan kebutuhan pasar kerja.</p>
                    </div>
                    <div class="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1 border-t-4 border-primary-blue"
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Teaching Factory</h3>
                        <p class="text-gray-600">Laboratorium yang berfungsi sebagai pabrik mini, memberikan pengalaman
                            kerja nyata dalam lingkungan sekolah.</p>
                    </div>
                    <div class="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1 border-t-4 border-primary-blue"
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Kemitraan Industri</h3>
                        <p class="text-gray-600">Jaringan luas dengan perusahaan terkemuka untuk program magang (PKL)
                            dan penyaluran kerja lulusan.</p>
                    </div>
                </div>
            </div>
        </section>
