            ...
            <table class="table table-hover">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-label-info me-1">{{ $pegawai->tipe_pegawai }}</span></td>
                        <td><span class="badge bg-label-success me-1">{{ $pegawai->status }}</span></td>
                        <td>
                            <div class="d-flex">
                                <a class="btn btn-icon btn-sm btn-outline-secondary me-1" href="{{ route('admin.pegawai.show', $pegawai->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat">
                                    <i class="bx bx-show"></i>
                                </a>
                                <a class="btn btn-icon btn-sm btn-outline-primary me-1" href="{{ route('admin.pegawai.edit', $pegawai->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
