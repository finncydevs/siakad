...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Rombongan Belajar / Praktik /</span> Tambah Data
</h4>

<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Form Tambah Rombel Praktik</h5>
    </div>
    <div class="card-body">
        <form action="#" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_rombel" name="nama_rombel" placeholder="Contoh: Praktik RPL A">
                    </div>
                </div>
            ...
            <div class="mt-2">
                ...
                <a href="{{ route('admin.rombel.praktik.index') }}" class="btn btn-outline-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
