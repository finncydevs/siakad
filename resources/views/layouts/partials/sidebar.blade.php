<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->is('admin/profil-sekolah*') ? 'active' : '' }}">
            <a href="{{ route('admin.profil-sekolah.edit') }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->is('admin/pegawai*') || request()->is('admin/tugas-pegawai*') ? 'open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->is('admin/tugas-pegawai*') ? 'active' : '' }}">
                    <a href="{{ route('admin.tugas-pegawai.index') }}" class="menu-link">
                ...
                <li class="menu-item {{ request()->is('admin/kesiswaan/ppdb*') ? 'open' : '' }}">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.tahun-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.tahun-ppdb.index') }}" class="menu-link"><div data-i18n="Tahun PPDB">Tahun PPDB</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.jalur-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.jalur-ppdb.index') }}" class="menu-link"><div data-i18n="Jalur Pendaftaran">Jalur Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.quota-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.quota-ppdb.index') }}" class="menu-link"><div data-i18n="Quota">Quota Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.syarat-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.syarat-ppdb.index') }}" class="menu-link"><div data-i18n="Syarat">Syarat Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.formulir-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.formulir-ppdb.index') }}" class="menu-link"><div data-i18n="Formulir">Formulir Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.daftar-calon-peserta-didik.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.daftar-calon-peserta-didik.index') }}" class="menu-link"><div data-i18n="Calon Peserta Didik">Calon Peserta Didik</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.penempatan-kelas.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.penempatan-kelas.index') }}" class="menu-link"><div data-i18n="Penempatan Kelas">Penempatan Kelas</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.laporan-pendaftaran.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.laporan-pendaftaran.index') }}" class="menu-link"><div data-i18n="Laporan Pendaftaran">Laporan Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.ppdb.laporan-quota.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.ppdb.laporan-quota.index') }}" class="menu-link"><div data-i18n="Laporan Quota">Laporan Quota</div></a>
                        </li>
                    </ul>
                </li>
                <li class="menu-item">
