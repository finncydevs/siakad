<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
            <span class="app-brand-logo demo">
                {{-- SVG Logo Anda --}}
                <svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <defs>
                    ...
                    <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="Brand-Logo" transform="translate(-27.000000, -15.000000)"><g id="Icon" transform="translate(27.000000, 15.000000)"><g id="Mask" transform="translate(0.000000, 8.000000)"><mask id="mask-2" fill="white"><use xlink:href="#path-1"></use></mask><use fill="#696cff" xlink:href="#path-1"></use><g id="Path-3" mask="url(#mask-2)"><use fill="#696cff" xlink:href="#path-3"></use><use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-3"></use></g><g id="Path-4" mask="url(#mask-2)"><use fill="#696cff" xlink:href="#path-4"></use><use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-4"></use></g></g><g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) "><use fill="#696cff" xlink:href="#path-5"></use><use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use></g></g></g></g>
                </svg>
            </span>
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Kesiswaan -->
        <li class="menu-header small text-uppercase"><span class="menu-header-text">Kesiswaan</span></li>
                ...
                <li class="menu-item {{ request()->is('admin/kesiswaan/ppdb*') ? 'open' : '' }}">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.tahun-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.tahun-ppdb.index') }}" class="menu-link"><div data-i18n="Tahun PPDB">Tahun PPDB</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.jalur-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.jalur-ppdb.index') }}" class="menu-link"><div data-i18n="Jalur Pendaftaran">Jalur Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.quota-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.quota-ppdb.index') }}" class="menu-link"><div data-i18n="Quota">Quota Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.syarat-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.syarat-ppdb.index') }}" class="menu-link"><div data-i18n="Syarat">Syarat Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.formulir-ppdb.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.formulir-ppdb.index') }}" class="menu-link"><div data-i18n="Formulir">Formulir Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.daftar-calon-peserta-didik.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.daftar-calon-peserta-didik.index') }}" class="menu-link"><div data-i18n="Calon Peserta Didik">Calon Peserta Didik</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.penempatan-kelas.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.penempatan-kelas.index') }}" class="menu-link"><div data-i18n="Penempatan Kelas">Penempatan Kelas</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.laporan-pendaftaran.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.laporan-pendaftaran.index') }}" class="menu-link"><div data-i18n="Laporan Pendaftaran">Laporan Pendaftaran</div></a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.kesiswaan.ppdb.laporan-quota.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.kesiswaan.ppdb.laporan-quota.index') }}" class="menu-link"><div data-i18n="Laporan Quota">Laporan Quota</div></a>
                        </li>
                    </ul>
                </li>
